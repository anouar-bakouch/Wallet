...
from BudgetPRed.views import AddItemView, DeleteItemView, GetItemView, ListItemsView, PredictBudgetView, PredictedItems, TokenPairObtainView, TokenRefreshView, TokenVerifyView, UpdateBudgetView, index, signInView, signUpView
urlpatterns = [
    path('',index),
