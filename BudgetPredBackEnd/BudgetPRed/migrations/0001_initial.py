# Generated by Django 4.2.2 on 2023-08-14 17:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('path_photo', models.ImageField(default='images/no-user-img.jpg', upload_to='static/images')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_purchase', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='BudgetPRed.itempurchase')),
